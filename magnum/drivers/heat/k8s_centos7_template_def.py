...
class K8sCentos7TemplateDefinition(k8s_template_def.K8sTemplateDefinition):
    ...
    def __init__(self):
        super(K8sCentos7TemplateDefinition, self).__init__()
    ...
    def get_params(self, context, cluster_template, cluster, **kwargs):
        ...
        dns_cluster_domain = cluster.labels.get('service_cluster_domain')
        if dns_cluster_domain:
            extra_params['dns_cluster_comain'] = dns_cluster_domain
