...
class K8sBkeTemplateDefinition(k8s_template_def.K8sTemplateDefinition):
    """Kubernetes template for a Bke."""

    def __init__(self):
        super(K8sBkeTemplateDefinition, self).__init__()
    ...
    def get_params(self, context, cluster_template, cluster, **kwargs):
        ...
        return super(K8sBkeTemplateDefinition,
